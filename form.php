...
<html lang="en">
  ...
  <body>
    ...
    <div class="form-page">
      <div class="personal-info">
        <div class="profile-image" id="image-container" name="image-container" onclick="chooseImage()">
          Choisir une photo de cv
          <img src="./upload.png" alt="" height="15" id="image-container" name="image-container"/>
        </div>
  ...
  const imageInput = document.getElementById("photo").files[0];
    ...
    reader.onload = function (e) {
      ...
      localStorage.setItem("cv-data", dataString);
    };
...
document.getElementById("photo").addEventListener("change", handleImageChange);
...
function handleImageChange() {
  ...
  if (selectedFile) {
    imageContainer.innerHTML = `<img src="${URL.createObjectURL(
      selectedFile
    )}" alt="Selected Image" style="width: 100%;height: 100%;border-radius: 50px;">`;
